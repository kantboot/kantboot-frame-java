...
@Getter
@Setter
@Table(name = "thirdparty_alicloud_market_request")
@Accessors(chain = true)
@EntityListeners(AuditingEntityListener.class)
@DynamicUpdate
@DynamicInsert
public class ThirdpartyAlicloudMarketRequest
    ...
    private List<ThirdpartyAlicloudMarketRequestQuery> queries;

    @OneToMany(cascade = CascadeType.ALL, fetch = FetchType.EAGER)
    @JoinColumn(name = "request_id")
    private List<ThirdpartyAlicloudMarketRequestBody> bodies;
